		...
		<div class="content tab-content">
			...
			<div id="uploadByExam" class="form-inline filter-block tab-pane fade in active">
				<div class="description">
					...
					<p>2. 仅支持.xls或.xlsx格式的Excel文件</p>
					<p>3. 科目信息和顺序必须和显示的考试信息一致</p>
					<p>4. 文件中的行数应等于考试人数，否则报错</p>
					<p>5. 系统默认将会为每科成绩排名</p>
					
					<p class="strong">举例说明：</p>
					<p>上传的是2016年下学期的第一学月考试，则</p>
					<p>先选择学期为“2016_2017下学期”，再选择考试为“第一学月考试”，</p>
			...
			<div id="uploadBatch" class="form-inline filter-block tab-pane fade">
				<div class="description">
					...
					<p>2. 文件夹名字必须按照“2016_2017上学期”规范</p>
					...
					<p>在“2016_2017下学期”文件夹中包含第一学月.xls，第二学月.xls，期末考试.xls，</p>
					<p>在“2017_2018上学期”文件夹中包含半期考试.xls，期末考试.xls，然后把这两个文件夹压缩成zip文件并选择它们即可</p>
				</div>
